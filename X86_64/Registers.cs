...
namespace Unicorn.X86_64
{
    public class Registers : X86.Registers
    {
        ...
        public ulong CR0
        {
            get
            {
                this.Table.Read(X86.Register.CR0, out ulong value);
                return value;
            }
        ...
        public ulong CR1
        {
            get
            {
                this.Table.Read(X86.Register.CR1, out ulong value);
                return value;
            }
        ...
        public ulong CR2
        {
            get
            {
                this.Table.Read(X86.Register.CR2, out ulong value);
                return value;
            }
        ...
        public ulong CR3
        {
            get
            {
                this.Table.Read(X86.Register.CR3, out ulong value);
                return value;
            }
        ...
        public ulong CR4
        {
            get
            {
                this.Table.Read(X86.Register.CR4, out ulong value);
                return value;
            }
        ...
        public ulong DR0
        {
            get
            {
                this.Table.Read(X86.Register.DR0, out ulong value);
                return value;
            }
        ...
        public ulong DR1
        {
            get
            {
                this.Table.Read(X86.Register.DR1, out ulong value);
                return value;
            }
        ...
        public ulong DR2
        {
            get
            {
                this.Table.Read(X86.Register.DR2, out ulong value);
                return value;
            }
        ...
        public ulong DR3
        {
            get
            {
                this.Table.Read(X86.Register.DR3, out ulong value);
                return value;
            }
        ...
        public ulong DR4
        {
            get
            {
                this.Table.Read(X86.Register.DR4, out ulong value);
                return value;
            }
        ...
        public ulong DR5
        {
            get
            {
                this.Table.Read(X86.Register.DR5, out ulong value);
                return value;
            }
        ...
        public ulong DR6
        {
            get
            {
                this.Table.Read(X86.Register.DR6, out ulong value);
                return value;
            }
        ...
        public ulong DR7
        {
            get
            {
                this.Table.Read(X86.Register.DR7, out ulong value);
                return value;
            }
